...
class TestAttendance(SavepointCase):
    ...
    def test_attendance_date(self):
        attendance = self._create_attendance('2021-12-02 06:00:00', '2021-12-02 15:00:00')
    ...
    def test_attendance_date_type_sunday(self):
        attendance = self._create_attendance('2021-12-05 06:00:00', '2021-12-05 15:00:00')
        self.assertEqual(attendance.date_type, 'sunday')

    def test_attendance_date_type_public_holiday(self):
        attendance = self._create_attendance('2021-11-01 06:00:00', '2021-11-01 15:00:00')
    ...
    def test_attendance_worktime_no_check_out(self):
        ...
        self.assertEqual(attendance.worked_hours_nighttime, 0.)
        self.assertEqual(attendance.worked_hours_daytime, 0.)

    def test_attendance_worktime_just_day(self):
        attendance = self._create_attendance('2021-12-02 06:00:00', '2021-12-02 15:00:00')
        self.assertEqual(attendance.worked_hours_nighttime, 0.)
        self.assertEqual(attendance.worked_hours_daytime, 9.)

    def test_attendance_worktime_start_early(self):
        attendance = self._create_attendance('2021-12-02 03:00:00', '2021-12-02 12:00:00')
        self.assertEqual(attendance.worked_hours_nighttime, 2.)
        self.assertEqual(attendance.worked_hours_daytime, 7.)

    def test_attendance_worktime_end_late(self):
        attendance = self._create_attendance('2021-12-02 15:00:00', '2021-12-03 00:00:00')
        self.assertEqual(attendance.worked_hours_nighttime, 3.)
        self.assertEqual(attendance.worked_hours_daytime, 6.)

    def test_attendance_worktime_night_shift(self):
        attendance = self._create_attendance('2021-12-02 21:00:00', '2021-12-03 06:00:00')
        self.assertEqual(attendance.worked_hours_nighttime, 8.)
        self.assertEqual(attendance.worked_hours_daytime, 1.)

    def test_attendance_worktime_too_long(self):
        with self.assertRaises(exceptions.UserError) as cm:
            attendance = self._create_attendance('2021-12-02 20:00:00', '2021-12-03 21:00:00')
